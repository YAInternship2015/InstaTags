...
#warning Не смог применить данную рекомендацию, тК при переборке массива внутри блока MagicalRecord происходит сбой при обновлении контента tableView & collectionView
